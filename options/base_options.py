...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--batchSize', type=int, default=16, help='input batch size')  # default=1 for raw code
        ...
        parser.add_argument('--n_outbranches', type=int, default=-1, help='# of output branches of UNet')
